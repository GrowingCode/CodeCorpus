...
//    private LocalTableModel model = new LocalTableModel();
	...
	public DeleteFrame() {
		...
		JPanel dsadslodovopzvcpva = new JPanel();
		dsadslodovopzvcpva.setBounds(0, 0, 434, 291);
		contentPane.add(dsadslodovopzvcpva);
		dsadslodovopzvcpva.setLayout(null);
		...
		dsadslodovopzvcpva.add(messageLabel);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(34, 70, 364, 173);
		dsadslodovopzvcpva.add(scrollPane);
...
//        }
		...
		dsadslodovopzvcpva.add(deleteButton);
		...
		dsadslodovopzvcpva.add(closeButton);
	}
