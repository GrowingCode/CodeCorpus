...
all_skt_one_parent_hint_mask_file.close()
all_skt_one_parent_hint_mask = np.array(all_skt_one_parent_hint_mask_ts)

all_skt_pe_parent_hint_mask_file = open(data_dir + "/All_skt_pe_parent_hint_mask.json", 'r', encoding='UTF-8')
all_skt_pe_parent_hint_mask_ts = json.load(all_skt_pe_parent_hint_mask_file)
all_skt_pe_parent_hint_mask_file.close()
all_skt_pe_parent_hint_mask = np.array(all_skt_pe_parent_hint_mask_ts)

all_skt_e_parent_hint_mask_file = open(data_dir + "/All_skt_e_parent_hint_mask.json", 'r', encoding='UTF-8')
